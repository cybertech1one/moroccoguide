...
const restaurants: RestaurantItem[] = [
  { name: 'NOMAD', slug: 'nomad', cityName: 'Marrakech', cuisineType: 'rooftop', priceRange: 3, description: 'A trendy rooftop restaurant above the spice square offering modern Moroccan cuisine with panoramic medina views. One of the most sought-after tables in the city.', specialties: ['Lamb Shoulder', 'Zaalouk', 'Moroccan Salads', 'Rooftop Cocktails'], rating: 4.6, image: '/images/photo-tagine-closeup.webp' },
  { name: 'Le Jardin', slug: 'le-jardin', cityName: 'Marrakech', cuisineType: 'moroccan', priceRange: 3, description: 'A lush garden restaurant hidden in the medina serving refined Moroccan cuisine amid tropical plants and birdsong. A tranquil oasis from the bustling souks.', specialties: ['Tagine with Prunes', 'Pastilla', 'Fresh Juices', 'Garden Salads'], rating: 4.5, image: '/images/photo-tagine-closeup.webp' },
  { name: 'Cafe Clock', slug: 'cafe-clock-fes', cityName: 'Fes', cuisineType: 'fusion', priceRange: 2, description: 'A cultural cafe in a restored medina house famous for its camel burger and traditional music nights. A hub for cultural exchange and creative energy in the Fes medina.', specialties: ['Camel Burger', 'Moroccan Tapas', 'Date Milkshake', 'Live Gnawa Music'], rating: 4.4, image: '/images/hero-fes.webp' },
  { name: 'Chez Lamine Hadj Mustapha', slug: 'chez-lamine', cityName: 'Marrakech', cuisineType: 'street_food', priceRange: 1, description: 'A legendary hole-in-the-wall serving the best tangia in Marrakech since the 1960s. The slow-cooked lamb is prepared in a clay urn buried in the hammam coals overnight.', specialties: ['Tangia', 'Slow-cooked Lamb', 'Moroccan Bread', 'Mint Tea'], rating: 4.7, image: '/images/photo-tagine-closeup.webp' },
  { name: 'La Sqala', slug: 'la-sqala', cityName: 'Casablanca', cuisineType: 'moroccan', priceRange: 2, description: 'A charming garden restaurant set in an 18th-century bastion, famous for its traditional Moroccan breakfasts and generous tagines. A Casablanca institution for locals and visitors alike.', specialties: ['Moroccan Breakfast', 'Tagine', 'Fresh Pastries', 'Garden Setting'], rating: 4.3, image: '/images/hero-essaouira.webp' },
  { name: 'Le Dhow', slug: 'le-dhow', cityName: 'Rabat', cuisineType: 'international', priceRange: 3, description: 'A converted wooden dhow boat moored on the Bou Regreg river between Rabat and Sale, serving international cuisine with stunning views of the Kasbah of the Udayas at sunset.', specialties: ['Seafood Platter', 'Steak', 'Sunset Cocktails', 'River Views'], rating: 4.4, image: '/images/hero-morocco.webp' },
  { name: 'Sam\'s Fish', slug: 'sams-fish', cityName: 'Essaouira', cuisineType: 'seafood', priceRange: 1, description: 'The most popular of the harbor fish grills in Essaouira, serving the freshest catch of the day grilled to order on outdoor charcoal braziers at unbeatable prices.', specialties: ['Grilled Sardines', 'Shrimp Skewers', 'Mixed Fish Platter', 'Sea Urchin'], rating: 4.6, image: '/images/hero-essaouira.webp' },
  { name: 'Henna Cafe', slug: 'henna-cafe', cityName: 'Marrakech', cuisineType: 'cafe', priceRange: 1, description: 'A charming social enterprise cafe in the medina offering organic food, henna art, and rooftop views. All profits support local community education and women\'s empowerment projects.', specialties: ['Organic Salads', 'Smoothie Bowls', 'Henna Art', 'Mint Tea'], rating: 4.5, image: '/images/photo-tagine-closeup.webp' },
  { name: 'Dar Hatim', slug: 'dar-hatim', cityName: 'Fes', cuisineType: 'moroccan', priceRange: 2, description: 'An authentic family-run restaurant in the heart of the Fes medina offering home-cooked Fassi cuisine. The set menu changes daily and represents centuries of culinary tradition.', specialties: ['Fassi Tagine', 'Harira Soup', 'Mechoui', 'Rfissa'], rating: 4.6, image: '/images/hero-fes.webp' },
