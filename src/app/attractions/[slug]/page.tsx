...
const attractions: Attraction[] = [
  {
    ...
    nearbyAttractions: [
      { name: 'Jardin Majorelle', slug: 'jardin-majorelle', image: 'https://images.unsplash.com/photo-1585232004423-244e0e6904e3?w=600&q=80' },
      { name: 'Bahia Palace', slug: 'bahia-palace', image: 'https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=600&q=80' },
      { name: 'El Badi Palace', slug: 'el-badi-palace', image: 'https://images.unsplash.com/photo-1570698473651-b2de99bae12f?w=600&q=80' },
    ],
  ...
  },
  {
    ...
    nearbyAttractions: [
      { name: 'Kasbah of the Udayas', slug: 'kasbah-udayas', image: 'https://images.unsplash.com/photo-1570698473651-b2de99bae12f?w=600&q=80' },
      { name: 'Hassan Tower', slug: 'hassan-tower', image: 'https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=600&q=80' },
      { name: 'Volubilis Roman Ruins', slug: 'volubilis', image: 'https://images.unsplash.com/photo-1545041117-2f58be4c4584?w=600&q=80' },
    ],
  ...
  },
  {
    ...
    nearbyAttractions: [
      { name: 'Chouara Tannery', slug: 'chouara-tannery', image: 'https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=600&q=80' },
      { name: 'Volubilis Roman Ruins', slug: 'volubilis', image: 'https://images.unsplash.com/photo-1545041117-2f58be4c4584?w=600&q=80' },
      { name: 'Blue Medina, Chefchaouen', slug: 'chefchaouen-medina', image: 'https://images.unsplash.com/photo-1553244886-a796b2e8e01f?w=600&q=80' },
    ],
  ...
  },
  {
    ...
    nearbyAttractions: [
      { name: 'Todra Gorge', slug: 'todra-gorge', image: 'https://images.unsplash.com/photo-1504233529578-6d46baba6d34?w=600&q=80' },
      { name: 'Erg Chebbi Dunes', slug: 'erg-chebbi', image: 'https://images.unsplash.com/photo-1509023464722-18d996393ca8?w=600&q=80' },
      { name: 'Ouzoud Waterfalls', slug: 'ouzoud-falls', image: 'https://images.unsplash.com/photo-1533551268962-824e232b7869?w=600&q=80' },
    ],
  ...
  },
  {
    ...
    nearbyAttractions: [
      { name: 'Jemaa el-Fnaa', slug: 'jemaa-el-fnaa', image: 'https://images.unsplash.com/photo-1587974928442-77dc3e0dba72?w=600&q=80' },
      { name: 'Bahia Palace', slug: 'bahia-palace', image: 'https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=600&q=80' },
      { name: 'El Badi Palace', slug: 'el-badi-palace', image: 'https://images.unsplash.com/photo-1570698473651-b2de99bae12f?w=600&q=80' },
    ],
  ...
  },
  {
    ...
    nearbyAttractions: [
      { name: 'Fes el-Bali Medina', slug: 'fes-medina', image: 'https://images.unsplash.com/photo-1549180030-48bf079c5993?w=600&q=80' },
      { name: 'Chouara Tannery', slug: 'chouara-tannery', image: 'https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=600&q=80' },
      { name: 'Hassan Tower', slug: 'hassan-tower', image: 'https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=600&q=80' },
    ],
  ...
  },
  {
    ...
    nearbyAttractions: [
      { name: 'Erg Chebbi Dunes', slug: 'erg-chebbi', image: 'https://images.unsplash.com/photo-1509023464722-18d996393ca8?w=600&q=80' },
      { name: 'Ait Ben Haddou', slug: 'ait-ben-haddou', image: 'https://images.unsplash.com/photo-1489749798305-4fea3ae63d43?w=600&q=80' },
      { name: 'Ouzoud Waterfalls', slug: 'ouzoud-falls', image: 'https://images.unsplash.com/photo-1533551268962-824e232b7869?w=600&q=80' },
    ],
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1533551268962-824e232b7869?w=1200&q=80',
      'https://images.unsplash.com/photo-1504233529578-6d46baba6d34?w=1200&q=80',
      'https://images.unsplash.com/photo-1545041117-2f58be4c4584?w=1200&q=80',
    ],
    rating: 4.5,
  ...
  },
  {
    ...
    nearbyAttractions: [
      { name: 'Hassan Tower', slug: 'hassan-tower', image: 'https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=600&q=80' },
      { name: 'Hassan II Mosque', slug: 'hassan-ii-mosque', image: 'https://images.unsplash.com/photo-1569383746724-6f1b882b8f46?w=600&q=80' },
      { name: 'Volubilis Roman Ruins', slug: 'volubilis', image: 'https://images.unsplash.com/photo-1545041117-2f58be4c4584?w=600&q=80' },
    ],
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://cityguide.ma/attractions/${attraction.slug}`,
    },
  }
}
  ...
  const breadcrumbSchema = generateStructuredData('BreadcrumbList', {
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'Attractions',
        item: 'https://cityguide.ma/attractions',
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: attraction.name,
        item: `https://cityguide.ma/attractions/${attraction.slug}`,
      },
    ],
  })
