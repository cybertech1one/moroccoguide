        ...
        <div className="container-morocco">
          <div className="text-center mb-12">
            ...
            <p className="text-lg max-w-2xl mx-auto" style={{ color: '#1A1814', opacity: 0.7 }}>
              Morocco&apos;s elegant capital &mdash; where imperial history, Atlantic breezes,
              and modern culture converge along the banks of the Bouregreg.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { src: '/images/hero-rabat-kasbah.webp', alt: 'Blue and white walls of the Kasbah of the Udayas in Rabat overlooking the Atlantic' },
              { src: '/images/photo-moulay-idriss.webp', alt: 'The holy town of Moulay Idriss Zerhoun nestled in green hills near Rabat' },
            ].map((img, i) => (
