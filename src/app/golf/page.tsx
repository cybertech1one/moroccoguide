      ...
      <section className="py-12 md:py-16" style={{ backgroundColor: 'var(--surface-muted)' }}>
        <div className="container-morocco">
          <h2 className="font-[family-name:var(--font-display)] text-2xl md:text-3xl font-bold text-center mb-8" style={{ color: 'var(--text-primary)' }}>
            More Activity & Luxury Guides
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { href: '/morocco-golf-courses', title: 'Golf Courses Guide', desc: 'Detailed reviews of Morocco\'s top courses including green fees, difficulty ratings, and booking tips.' },
              { href: '/morocco-luxury-hotels', title: 'Luxury Hotels', desc: 'Hand-picked five-star riads, resorts, and boutique hotels for the most discerning travellers.' },
              { href: '/morocco-spa-guide', title: 'Spa & Hammam Guide', desc: 'Unwind after your round with Morocco\'s legendary hammam rituals and world-class spa treatments.' },
              { href: '/agadir', title: 'Agadir Guide', desc: 'Sun-drenched resort city with championship golf courses, beautiful beaches, and modern amenities.' },
              { href: '/marrakech', title: 'Marrakech Guide', desc: 'Explore the Red City\'s souks, palaces, and gardens alongside some of Morocco\'s most iconic golf courses.' },
              { href: '/best-time-visit-morocco', title: 'Best Time to Visit', desc: 'Season-by-season guide to weather, green fees, and the ideal months for golfing in Morocco.' },
            ].map((guide) => (
