...
export const metadata: Metadata = {
  title: 'Best 12 Restaurants in Marrakech | Where to Eat | CityGuide',
  description:
    'Discover the 12 best restaurants in Marrakech, Morocco. From rooftop terraces to hidden riads, find traditional Moroccan cuisine, modern fusion, and fine dining options with prices and ratings.',
  openGraph: {
...
export default function MarrakechRestaurantsPage() {
  const structuredData = generateStructuredData('ItemList', {
    ...
    description: 'The 12 best restaurants and dining experiences in Marrakech, Morocco.',
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="container-morocco relative z-10">
          ...
          <p className="text-xl text-white/80 max-w-2xl">
            From hidden riad restaurants to rooftop terraces overlooking the medina, discover
            Marrakech&apos;s 12 best dining experiences.
          </p>
        </div>
      </section>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-[var(--text-muted)] mt-1">
                {restaurants.length} dining spots in Marrakech
              </p>
            </div>
      ...
      <section className="py-12 md:py-16">
        <div className="container-morocco text-center">
          <h2 className="text-3xl font-[family-name:var(--font-display)] font-bold text-[var(--text-primary)] mb-4">
            Complete Your Marrakech Trip
          </h2>
          <p className="text-lg text-[var(--text-secondary)] max-w-xl mx-auto mb-8">
            Explore attractions and find the perfect place to stay in the Red City.
          </p>
