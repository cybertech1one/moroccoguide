...
export const metadata: Metadata = {
  title: 'Top 15 Marrakech Attractions | Must-See 2026',
  description:
    'Discover the 15 best attractions in Marrakech. Jemaa el-Fnaa, Jardin Majorelle, Bahia Palace, and more with hours and fees. Plan your visit today!',
  keywords: [
    ...
    'El Badi Palace',
    'Marrakech medina attractions',
    'Marrakech opening hours',
    'best places Marrakech',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Jemaa el-Fnaa square in Marrakech Morocco at sunset',
      },
    ],
  },
  twitter: {
    ...
    title: 'Top 15 Marrakech Attractions | Must-See 2026',
    description:
      'Jemaa el-Fnaa, Jardin Majorelle, Bahia Palace, and 12 more must-see sights in Marrakech with hours and fees.',
  },
  alternates: {
    ...
    <>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              'url(/images/hero-marrakech-koutoubia.webp)',
          }}
        />
