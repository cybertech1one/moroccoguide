...
export const metadata: Metadata = {
  title: 'Top 12 Fes Attractions | Must-See Sights 2026',
  description:
    'Discover the 12 best attractions in Fes, Morocco. Ancient medina, Chouara Tannery, Bou Inania Madrasa, and more. Plan your visit today!',
  keywords: [
    'Fes attractions',
    'things to do in Fes',
    'Fes medina',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Fes el-Bali medina aerial view in Morocco',
      },
    ],
  },
  twitter: {
    ...
    title: 'Top 12 Fes Attractions | Must-See Sights 2026',
    description:
      'Chouara Tannery, Bou Inania Madrasa, ancient medina, and 9 more must-see sights in Fes with visitor info.',
  },
  alternates: {
