...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Morocco Festivals Guide | Top 15 Events',
    description:
      'Gnaoua, Mawazine, Fes Sacred Music, Rose Festival, and more. Practical tips for attending Morocco\'s best festivals.',
  },
...
const festivals: Festival[] = [
  ...
  },
  {
    ...
    images: [
      '/images/art-gnawa-music.webp',
      '/images/hero-berber-culture.webp',
      '/images/photo-fantasia-tbourida.webp',
    ],
    icon: Music,
    highlight: true,
  ...
  },
  {
    ...
    images: [
      '/images/hero-asilah-aerial.webp',
      '/images/hero-marrakech.webp',
      '/images/hero-morocco.webp',
    ],
    icon: Globe,
