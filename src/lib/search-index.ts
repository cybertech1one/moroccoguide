...
export function buildSearchIndex(): SearchItem[] {
  ...
  const pages: Omit<SearchItem, 'id'>[] = [
    ...
    {
      title: 'Morocco Birdwatching Guide 2026',
      description: 'Top birding sites in Morocco — Souss-Massa, Merja Zerga, Oualidia, Ifrane with species lists, seasons, and guided tour options.',
      type: 'page',
      url: '/morocco-birdwatching',
      tags: ['birdwatching', 'wildlife', 'Northern Bald Ibis', 'Souss-Massa', 'nature'],
      keywords: ['morocco birdwatching', 'birding morocco', 'souss massa birds', 'northern bald ibis', 'morocco wildlife'],
      priority: 9,
    },
    {
      title: 'Morocco Mountain Biking Guide 2026',
      description: 'Mountain biking trails in Morocco — Atlas Mountains, desert fatbiking, coastal routes with difficulty ratings, rental, and guided tours.',
      type: 'page',
      url: '/morocco-mountain-biking',
      tags: ['mountain biking', 'cycling', 'Atlas Mountains', 'adventure', 'trails'],
    ...
    {
      title: 'Solo Travel in Morocco Guide 2026',
      description: 'Complete solo travel guide for Morocco — safety tips, best cities, budget advice, female solo travel, hostels, and meeting other travelers.',
      type: 'page',
      url: '/morocco-solo-travel',
      tags: ['solo travel', 'safety', 'backpacking', 'hostels', 'female travel'],
      keywords: ['morocco solo travel', 'solo travel morocco safe', 'female solo travel morocco', 'morocco hostels', 'backpacking morocco alone'],
      priority: 9,
    },
    {
      title: 'Morocco Honeymoon Guide 2026',
      description: 'Plan your Morocco honeymoon — romantic riads, desert glamping, couple activities, itineraries, and budget breakdown for honeymooners.',
      type: 'page',
      url: '/morocco-honeymoon',
      tags: ['honeymoon', 'romantic', 'couples', 'luxury', 'riads'],
    ...
    {
      title: 'Morocco Hammam Etiquette — Complete Guide to the Traditional Bathhouse',
      description: 'Hammam etiquette guide — step-by-step ritual, public vs private hammams, what to bring, tipping, dress code, health benefits, and best hammams by city.',
      type: 'page',
      url: '/morocco-hammam-etiquette',
      tags: ['hammam', 'etiquette', 'bathhouse', 'wellness', 'culture'],
      keywords: ['morocco hammam etiquette', 'hammam rules morocco', 'traditional hammam experience', 'moroccan bath house', 'hammam tips'],
      priority: 9,
    },
    {
      title: 'Morocco Rug Buying Guide — Types, Prices, Haggling & Shipping',
      description: 'Complete guide to buying Moroccan rugs — Beni Ourain, Azilal, Kilim types, quality tests, fair prices, haggling strategies, and shipping options.',
      type: 'page',
      url: '/morocco-rug-buying',
      tags: ['rugs', 'carpets', 'shopping', 'handicrafts', 'souks'],
