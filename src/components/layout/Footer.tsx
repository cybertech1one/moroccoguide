...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Shopping Guide', href: '/morocco-shopping-guide' },
      { label: 'Nightlife Guide', href: '/morocco-nightlife-guide' },
      { label: 'Spa & Hammam', href: '/morocco-spa-guide' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Photography', href: '/photography-guide' },
      { label: 'Road Trips', href: '/morocco-road-trip-routes' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Safety Tips', href: '/morocco-safety-tips' },
      { label: 'Money & Currency', href: '/money' },
      { label: 'Weather Monthly', href: '/morocco-weather-monthly' },
      ...
      { label: 'Train Routes', href: '/morocco-train-routes' },
      { label: 'Airports Guide', href: '/morocco-airports-guide' },
      { label: 'Morocco for Locals', href: '/morocco-for-locals' },
    ],
  },
  {
    title: 'Travel Styles',
    links: [
      ...
      { label: 'Digital Nomads', href: '/morocco-digital-nomad-guide' },
      { label: 'Wedding Venues', href: '/morocco-wedding-venues' },
