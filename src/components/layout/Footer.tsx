...
const footerColumns = [
  {
    ...
    links: [
      ...
      { label: 'Fes', href: '/cities/fes' },
      { label: 'Chefchaouen', href: '/cities/chefchaouen' },
      { label: 'Essaouira', href: '/cities/essaouira' },
      { label: 'Tangier', href: '/cities/tangier' },
      { label: 'Rabat', href: '/cities/rabat' },
      { label: 'Casablanca', href: '/cities/casablanca' },
      { label: 'Merzouga', href: '/cities/merzouga' },
      { label: 'Ouarzazate', href: '/cities/ouarzazate' },
      { label: 'Agadir', href: '/cities/agadir' },
    ],
  },
  {
    title: 'Explore',
